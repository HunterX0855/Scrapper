...
\033[0;96m FACEBOOK ACCOUNT SCRAPER \033[0;96m║ \033[0;97mFB \033[0;96m: \033[0;97mFacebook.com/https://web.facebook.com/infosec.855
\033[0;96mHUNTER 4X4  \033[0;96m║ \033[0;97mGithub \033[0;96m: \033[0;97mGithub.com/
\033[0;96m─────────────────────────────────────────────────────────────""")
...
def menu():
  ...
  print("\033[0;96m╠══\033[0;97m[2] scrap ID's")
...
def publik():
	...
	try:
                ...
                banner()
                print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print("\033[0;96m╔══\033[0;97m[•] Enter user ID with public friends list")
		...
		ys.close()
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print ('\033[0;96m╔══\033[0;97m[•] Fetching Successfull %s'%op['name'])
...
def mbasic(em,pas,hosts):
	...
	else:return {"status":"error","email":em,"pass":pas}#Scrap mbasic
def m_fb(em,pas,hosts):
	...
	if "c_user" in r.cookies.get_dict().keys():
		...
		return {"status":"cp","email":em,"pass":pas,"cookies":r.cookies.get_dict()}
	else:return {"status":"error","email":em,"pass":pas}#Scrap m.fb
...
def methode():
  ...
  banner()
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[  Method Scraping ]")
  print("\033[0;96m║")
  print("\033[0;96m╠══\033[0;97m[1] Scrap With mbasic")
  print("\033[0;96m╠══\033[0;97m[2] Scrap With m.facebook.com")
  print("\033[0;96m╠══\033[0;97m[3] Scrap With touch.facebook.com")
  print("\033[0;96m╚══\033[0;97m[4] Scrap With api")
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
...
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[  Method Login ]")
  print("\033[0;96m║")
...
class Scrap:
	...
	def __init__(self):
		...
		self.cp=[]
		self.ko=0
		print("\033[0;96m╠══\033[0;97m[•] Scrap With Pass Default Or Manual [d/m]")
		while True:
			...
			if f=="":continue
				...
				try:
					...
					continue
                                print ("\033[0;96m─────────────────────────────────────────────────────────────")
				print ("\033[0;96m╔══\033[0;97m[•] Scrap Started...")
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print "\r   [Scrap] %s/%s - ok-:%s - cp-:%s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
class Scrap1:
        os.system("clear")
